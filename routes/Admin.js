...
router.get('/allCoupen', adminSession.adminSession, controller.allCoupen)
...
router.get("/addCoupenPage", adminSession.adminSession, controller.addCoupenPage)
...
router.post("/addCoupen", adminSession.adminSession, controller.addCoupen)
router.post("/deleteCoupen/:id", adminSession.adminSession, controller.deleteCoupen)
